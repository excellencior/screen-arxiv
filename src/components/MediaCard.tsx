...
export default function MediaCard({
    ...
    return (
        <motion.div
            ...
            className={`card border-0 shadow-sm p-3 d-flex flex-column gap-3 ${!isSearch || selectionMode ? 'cursor-pointer' : ''}`}
            onClick={handleClick}
            style={{
        ...
        >
            ...
            {/* Bottom row — hidden in selection mode */}
            {!selectionMode && (
                <div className="d-flex align-items-center justify-content-between mt-auto pt-2 border-top border-secondary border-opacity-10 w-100">
                    {!isSearch && onDelete && (
                        <button
